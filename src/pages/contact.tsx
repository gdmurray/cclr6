            ...
            <div className="space-y-4">
                <div>
                    ...
                    <div className="text-lg font-medium text-alt">
                        Send us an email at{' '}
                        <a className="text-link font-semibold" href="mailto:support@cclr6.com">
                            support@cclr6.com
                        </a>
                    </div>
                    <div className="text-xs text-base font-semibold tracking-tight text-alt-2">
                        There is a FAQ Coming Soon!
                    </div>
                </div>
                <div>
                    ...
                    <div className="text-lg font-medium text-alt">
                        Send us an email at{' '}
                        <a className="text-link font-semibold" href="mailto:partners@cclr6.com">
                            partners@cclr6.com
                        </a>
                    </div>
                </div>
                <div>
                    ...
                    <div className="text-lg font-medium text-alt">
                        Send us an email at{' '}
                        <a className="text-link font-semibold" href="mailto:positions@cclr6.com">
                            positions@cclr6.com
                        </a>
                    </div>
                </div>
