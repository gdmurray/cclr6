    ...
    return (
        <>
            <div className="container mx-auto flex px-5 lg:px-16 py-24 md:flex-row flex-col items-center">
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-8 flex flex-col md:items-start md:text-left items-center text-center">
                    <h1 className="dark:text-gray-50 tracking-tight font-heavy text-6xl mb-8 font-medium text-gray-900">
                        A NEW CHAPTER
                    </h1>
                    <p className="mb-8 text-xl font-normal tracking-tight leading-snug max-w-lg lg:max-w-xl">
                    ...
                    <div className="flex justify-center md:justify-start space-x-4 w-full">
                        ...
                        {features.registration ? (
                            ...
                            >
                                Register&nbsp;
                                <Badge
                                    colorScheme={colorMode === 'light' ? 'red' : 'black'}
                                    style={{
