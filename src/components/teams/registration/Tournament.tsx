...
export default function Tournament({ tournament }: { tournament: Tournament }): JSX.Element {
    return (
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            ...
                            <div className="flex flex-row items-center text-alt-2 font-medium text-sm">
                                <FaCalendarAlt />
                                &nbsp;{dayjs(tournament.scheduled_date_start).format('LL')}&nbsp;&nbsp;-&nbsp;&nbsp;
                                {dayjs(tournament.scheduled_date_end).format('LL')}
                            </div>
                        </div>
                    </div>
                    <div></div>
