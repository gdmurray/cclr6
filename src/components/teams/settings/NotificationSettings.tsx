...
const ToggleSetting = ({ name, icon, title, description }) => {
                ...
                <div>
                    <div className='flex flex-row justify-between'>
                        <div>
                            ...
                            <div className='text-subtitle-description'>The types of emails you would like to
                                receive
                            </div>
                        </div>
                        <div className='flex flex-col self-center'>
                            <Button
                                ...
                                isDisabled={!isDirty}>Update Preferences</Button>
                        </div>
                    </div>
                    <div className='p-2 py-4'>

                        <ToggleSetting name={'registration'}
                                       icon={<FaClipboard />}
                                       title={'Registration Emails'}
                                       description={'Receive emails confirming your registration to an event, including the events time and link'} />
                        <ToggleSetting name={'payment'}
                                       icon={<FaCreditCard />}
                                       title={'Payment Emails'}
                                       description={'Receive emails confirming your success payment for a Quals Pass '} />
                        <ToggleSetting name={'qualification'}
                                       icon={<FaTrophy />}
